...
Create rake task to send email notification of posts = status: submitted

1) Go to lib/notifcation.rake:
...
3) Type: rake notification:manager_email

Deploying to heroku

1) Make sure rails_12factor gem is installed for production
2) heroku create practice-overtime-app
3) git push heroku master
4) heroku rake db:setup
5) Fixing CSS issues:

Go to config/environments/products.rb:
